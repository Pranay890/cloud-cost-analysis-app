...
export function CostAnalysisClient() {
  ...
  const services = useMemo(() => {
    return Array.from(
      new Set(analytics?.records?.map((r) => r.service_name) ?? [])
    ).sort();
  }, [analytics]);
          ...
          <>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <Card className="p-5 h-[420px] flex flex-col">
                ...
                <div className="mt-4 space-y-3 overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-blue-500/30 hover:scrollbar-thumb-blue-500/60">
